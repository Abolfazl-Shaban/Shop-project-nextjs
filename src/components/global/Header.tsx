      ...
      >
        ...
        <div className='flex w-1/3 items-center justify-end gap-2'>
          <div className='relative hidden md:block'>
            <Input className='w-full' placeholder='جستجو محصولات' />
            <Search className='bg-white absolute top-0.5 left-0.5 size-8 cursor-pointer border-r p-1.5 text-zinc-600' />
          </div>
          <ShoppingCartIcon className='size-9 rounded-md border p-1.5 text-zinc-800 transition-all hover:bg-zinc-100' />
          ...
          <Sheet>
            ...
            <SheetContent onOpenAutoFocus={(e) => e.preventDefault()} autoFocus={false} className='p-2 [&>button:last-child]:hidden'>
              <SheetTitle>
              ...
              <form className='relative'>
                ...
                <Search  className='bg-white absolute focus top-0.5 left-0.5 size-11 cursor-pointer border-r p-2.5 text-zinc-600' />
              </form>
              <NavbarMenu />
            </SheetContent>
          </Sheet>
